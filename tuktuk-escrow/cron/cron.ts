...
const counterProgram = anchor.workspace.tuktukCounter as Program<AnchorEscrow>;
...
async function main() {
    ...
    const taskQueue = new anchor.web3.PublicKey("CJv1jLvFSLsV7X1UGq6bHr6XHacbJAfq7Tio8iqpEK6b");
