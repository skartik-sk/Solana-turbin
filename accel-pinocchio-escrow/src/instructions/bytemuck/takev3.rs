...
use crate::{state::{Escrow1, Escrow2}, util::ATA};

pub fn process_takev3_instruction(accounts: &[AccountView], _data: &[u8]) -> ProgramResult {
    ...
    let escrow: Escrow2 = {
            ...
            *bytemuck::from_bytes::<Escrow2>(&*escrow_data)
