...
use crate::{state::{Escrow1, Escrow3}, util::ATA};

pub fn process_takev4_instruction(accounts: &[AccountView], _data: &[u8]) -> ProgramResult {
    ...
    let escrow: Escrow3 = {
            ...
            serde_json::from_slice::<Escrow3>(&*escrow_data)
