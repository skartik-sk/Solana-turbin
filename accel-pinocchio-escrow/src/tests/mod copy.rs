...
mod tests {
    ...
    fn helper(mut svm:LiteSVM, payer:&Keypair, taker:Keypair)->(Pubkey,Pubkey,Pubkey,Pubkey,Pubkey,Pubkey,Pubkey,(Pubkey,u8),Pubkey,Pubkey,Pubkey,Pubkey){
        ...
        (program_id,mint_a,mint_b,maker_ata_a,maker_ata_b,taker_ata_a,taker_ata_b,escrow,vault,system_program,token_program,associated_token_program)
    }
    ...
    pub fn test_make_instruction() {
        ...
        let (program_id,mint_a,mint_b,maker_ata_a,maker_ata_b,taker_ata_a,taker_ata_b,escrow,vault,system_program,token_program,associated_token_program)=helper(svm.clone(),&payer,taker);
